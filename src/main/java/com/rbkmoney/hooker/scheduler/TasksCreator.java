...
@Deprecated
/*
* судя по всему особого смысла в этом сервисе нет, он всего лишь позволяет избежать одного запроса taskDao.create
* при каждом сохранении сообщения. Это потенциально может дать ускорение только при достаточно большом tasks.creator.delay
* и большой скорости потока ивентов
