...
public class HookDeleteDaoTest extends AbstractIntegrationTest {
    ...
    public void setUp() {
        ...
        batchService.process(buildBatchMessages(BuildUtils.buildMessage(InvoicingMessageEnum.INVOICE.value(),"2345", "partyId", EventType.INVOICE_CREATED, "status", cart(), true)));
